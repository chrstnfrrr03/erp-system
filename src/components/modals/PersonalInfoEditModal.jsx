...
export default function PersonalInfoEditModal({
    show,
    onHide,
    employee,
    onSave,
    ...
    useEffect(() => {
        if (employee && show) {
            ...
            const personalInfo =
                employee.personal_info || employee.personalInformation || {};

            setFormData({
                birthdate: formatDate(
                    employee.birthdate || personalInfo.birthdate
                ),
                age: employee.age || personalInfo.age || "",
                birthplace:
                    employee.birthplace || personalInfo.birthplace || "",
                nationality:
                    employee.nationality || personalInfo.nationality || "",
                civil_status:
                    employee.civil_status || personalInfo.civil_status || "",
                ...
                present_address:
                    ...
                    "",
                home_address:
                    employee.home_address || personalInfo.home_address || "",
                same_as_present: false,
                email_address:
                    employee.email_address || personalInfo.email_address || "",
                mobile_number:
                    employee.mobile_number || personalInfo.mobile_number || "",
                dependents:
                    employee.dependents || personalInfo.dependents || "",
    ...
    const handleChange = (e) => {
        ...
        if (type === "checkbox") {
            ...
            if (name === "same_as_present" && checked) {
                setFormData((prev) => ({
                    ...prev,
                    home_address: prev.present_address,
                }));
            }
        } else {
