...
class EmploymentInformationController extends Controller
{
    ...
    public function index()
    {
        return response()->json(
            EmploymentInformation::with('employee.shift')->get()
        );
    }
    ...
    {
        return response()->json(
            EmploymentInformation::with('employee.shift')->findOrFail($id)
        );
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json($record->fresh()->load('employee.shift'));
    }
    ...
    public function getEmployeeDetails($biometric_id)
{
    ...
    return response()->json([
        ...
        // ADD THIS: Include the personal_info object with id
   ...
   public function updateProfile(Request $request, $biometric_id)
{
    $request->validate([
        ...
        'employment_classification' => 'nullable|string', // CHANGED from employment_status
        'rate' => 'nullable|numeric',
    ...
    try {
        ...
        $employment->update([
            ...
            'employment_classification'  => $request->employment_classification,   // CHANGED
